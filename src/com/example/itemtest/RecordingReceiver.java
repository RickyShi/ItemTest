...
public class RecordingReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		/*
		 * Need add after merging using encryption
		 * try {
		 * String enformattedData = Utilities.encryption(fileHead.toString() +
		 * toWrite);
		 * } catch (Exception e) {
		 * e.printStackTrace();
		 * }
		...
		// Need to use below after mergeing. Same for the transmitData
		// transmitData.execute(toSend);
